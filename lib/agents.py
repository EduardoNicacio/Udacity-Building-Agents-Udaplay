...
class AgentState(TypedDict):
    ...
    session_id: str  # Session identifier for conversation state
...
class Agent:
    def __init__(self,
        ...
        Args:
            ...
            openai_api_key: Optional OpenAI API key (e.g. for Vocareum)
            openai_base_url: Optional OpenAI API base URL (e.g. for Vocareum)
        """
    ...
    def _llm_step(self, state: AgentState) -> AgentState:
        ...
        # Initialize LLM (supports Vocareum via api_key and base_url)
        llm = LLM(
